...
public class SoundAdapter {
     ...
     * However, it is perfectly safe to pass null to playSound().
     * 
     * @param x - Any 1.8 or 1.9 Sound String.
     * @return org.bukkit.Sound found on the running server or null.
     */
    public static Sound getSound(String x) {
